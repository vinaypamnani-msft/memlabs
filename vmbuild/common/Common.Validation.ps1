        ...
        foreach ($vm in $deployConfig.virtualMachines) {
            ...
            if ($vm.sqlVersion) {
                ...
                if ($vm.Role -eq "SQLAO") {
                    ...
                    # SQLAO partners may occupy different routed domain networks.
                    # Phase 1 allocates one cluster/listener IP per node subnet and
                    # Phase 5 configures the corresponding OR dependencies.
                }
            }
