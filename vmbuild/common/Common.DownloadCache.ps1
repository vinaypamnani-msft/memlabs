...
$global:MemlabsToolsVolumeLabel = 'MEMLABSTOOLS'
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                New-NoCloudSeedIsoWithImapi -SourceDir $stage -OutputIsoPath $tmpIso -VolumeLabel $global:MemlabsToolsVolumeLabel
