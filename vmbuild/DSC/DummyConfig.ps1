Configuration DummyConfig {
    ...
    Import-DscResource -ModuleName 'PSDesiredStateConfiguration', 'NetworkingDsc', 'xDhcpServer', 'SqlServerDsc', 'DnsServerDsc', 'ComputerManagementDsc', 'xDscDiagnostics', 'ActiveDirectoryDsc', 'xFailOverCluster', 'AccessControlDsc'
