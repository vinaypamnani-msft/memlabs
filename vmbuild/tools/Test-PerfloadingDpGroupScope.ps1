...
function Start-CMContentDistribution {
    ...
    if ($script:FailDistribution) { throw 'distribution failed' }
...
$synced = Sync-MemLabsContentDistribution -ContentType DeploymentPackage -ContentName 'MEMLABS-W10-11-CU-pkg' -DistributionPointGroupName 'All MEMLABS DPs' -LegacyDistributionPointGroupName 'ALL DPS' -MigrateLegacy $true -StatusTag '[test]'
...
$synced = Sync-MemLabsContentDistribution -ContentType Application -ContentName 'MEMLABS-App' -DistributionPointGroupName 'All MEMLABS DPs' -LegacyDistributionPointGroupName 'ALL DPS' -MigrateLegacy $true -StatusTag '[test]'
